  ...
  return (
    <View style={styles.container}>
      <AtomicCard style={styles.card}>
        ...
        <AppointmentInfoItem
          icon="Calendar"
          value={AppointmentFormattingService.formatDate(appointment.appointment_date, locale)}
          label={t('appointments.fields.date')}
        />

        <AppointmentInfoItem
          icon="Clock"
          value={AppointmentFormattingService.formatTime(appointment.appointment_time, locale)}
        ...
        {appointment.reminder_enabled && (
          <AppointmentInfoItem
            icon="Bell"
            value={`${appointment.reminder_time} ${t('appointments.detail.info.minutesBefore')}`}
            label={t('appointments.fields.reminder')}
          />
        )}
      </AtomicCard>
    </View>
