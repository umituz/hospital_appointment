...
export const DoctorsListHeader: React.FC<DoctorsListHeaderProps> = ({
  hasActiveFilter,
  onFilterPress,
  onSpecialtyPress,
  onHospitalPress,
  ...
  return (
    <View style={styles.container}>
      {onSpecialtyPress && (
        ...
        >
          <AtomicIcon name="Stethoscope" size="lg" color="secondary" />
        </TouchableOpacity>
      )}
      {onHospitalPress && (
        <TouchableOpacity
          ...
          hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
        >
          <AtomicIcon name="Building" size="lg" color="secondary" />
        </TouchableOpacity>
      )}
      <TouchableOpacity
